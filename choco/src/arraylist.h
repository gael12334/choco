...
_choco_arraylist_allocator _choco_arraylist_heap_choco_arraylist_allocator(void);
...
_choco_arraylist _choco_arraylist_resize(_choco_arraylist arrlist, size_t desired_alloc);
